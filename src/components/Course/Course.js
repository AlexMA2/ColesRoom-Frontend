...
const Course = ({id, curso_id, name, category,teacher_id}) => {
    ...
    const getDay = () => {
        ...
        let dtf = new Intl.DateTimeFormat('es-GB', { dateStyle: 'long'}).format(fecha)
        return dtf
    }
    ...
    return (
        <Card className={classes.root}>
            ...
            <CardActions disableSpacing className="separar">
                ...
                <Button variant="contained" color="primary" size="small" className={classes.sizeSmall} onClick={handleClick}>
                    Unirse
                </Button>
